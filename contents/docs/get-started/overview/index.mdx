---
title: Introduction
description: This section provides an overview of the Centennial OER student site.
---

Welcome to **Centennial College OER Lab Student Site**! This template provides a modern, flexible, and user-friendly foundation for creating engaging documentation. Whether you're building a knowledge base, project docs, or a personal blog, AriaDocs makes it easy to set up and scale.
