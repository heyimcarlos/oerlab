...
Cloning a book in **Pressbooks** allows you to create an exact copy, making it easy to customize, adapt, and build upon existing content. The cloning process preserves formatting, structure, and media.
Follow the below step-by-step guide on how to achieve cloning.
...
Check this official [Pressbooks guide](https://ecampusontario.pressbooks.pub/pressbooks/chapter/provide-access-to-others/) on how invite users to your books.

Add users to your book to share your work effectively. Pressbooks provides various user roles, but for simplicity, assign the Administrator role to all student developers for full access and a smoother workflow.
