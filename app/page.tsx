...
export default function Home() {
  return (
    <div className="flex sm:min-h-[85.5vh] min-h-[85vh] flex-col items-center justify-center text-center px-2 sm:py-8 py-12">
      <Link
        href="https://github.com/Centennial-College-OER-Lab"
        target="_blank"
        className="mb-5 sm:text-lg flex items-center gap-2 underline underline-offset-4 sm:-mt-12"
      >
        Follow along on GitHub <MoveUpRightIcon className="w-4 h-4 font-extrabold" />
      </Link>
      <h1 className="text-3xl font-bold mb-4 sm:text-6xl">Welcome to the Centennial College OER Lab</h1>
      <p className="mb-8 sm:text-lg max-w-[800px] text-muted-foreground">
        The Centennial College OER Lab is a student-led initiative to promote the use of open educational resources
        (OER) at Centennial College.
      </p>
